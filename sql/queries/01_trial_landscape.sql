...
-- 1. Phase × Status distribution (cross-tabulation)
-- 2. Yearly trial initiation trend (temporal evolution)
-- 3. Top 20 therapeutic areas by trial count
--
-- All outputs are plot-ready with clean column names and semantics.
-- ============================================================================
...
-- ============================================================================
-- Insight: Understand which phases have the most active/completed/recruiting trials
-- Use: Identify where research activity is concentrated
...
-- ============================================================================
-- Insight: Temporal evolution of clinical trial activity over time
-- Use: Detect growth patterns, identify peak years, understand research momentum
...
WHERE
    ...
    AND start_date != ''
    AND CAST(strftime('%Y', start_date) AS INTEGER) >= 1990  -- Focus on modern era
    AND CAST(strftime('%Y', start_date) AS INTEGER) <= 2025  -- Exclude future dates
GROUP BY start_year
HAVING trial_count >= 5  -- Filter noise from years with very few trials
ORDER BY start_year;
...
-- ============================================================================
-- Insight: Which diseases/conditions are most studied in clinical research
-- Use: Identify therapeutic priorities, understand research focus areas
...
HAVING trial_count >= 10  -- Focus on conditions with meaningful sample size
